"""simulation of the anomaly detection system
"""
import argparse
import os
...
map = perform(image=image, subdataset=config.subdataset, path=path, output_dir=config.output_dir, 
...
print("---------------------------")
print("Anomaly detection system complete.")
